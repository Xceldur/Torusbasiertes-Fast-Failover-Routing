...
if __name__ == '__main__':
    ...
    plt.xlabel('Iteration Step q')
    plt.legend(title='Failover Algorithm')
    plt.savefig("plots/cluster_step_ereichbarkeit.pdf", bbox_inches='tight', dpi=300)
    plt.show()
    ...
    plt.xlabel('Iteration Step q')
    plt.legend(title='Failover Algorithm')
    plt.savefig("plots/cluster_step_latencys.pdf", bbox_inches='tight', dpi=300)
    plt.show()
