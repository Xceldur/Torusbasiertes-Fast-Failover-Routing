...
if __name__ == '__main__':
    ...
    plt.xlabel('Anzahl an Knoten d')
    plt.legend(title='Failover Algorithm')
    plt.savefig("plots/cluster_node_ereichbarkeit.pdf", bbox_inches='tight', dpi=300)
    plt.show()
    ...
    plt.xlabel('Anzahl an Knoten d')
    plt.legend(title='Failover Algorithm')
    plt.savefig("plots/cluster_node_latencys.pdf", bbox_inches='tight', dpi=300)
    plt.show()
